...
export const kakaoJwtToken = createAsyncThunk('auth/kakaoJwtToken', async (code, thunkApi) => {
    try {
...
export const naverJwtToken = createAsyncThunk('auth/naverJwtToken', async (code, thunkApi) => {
    try {
...
export const googleJwtToken = createAsyncThunk('auth/googleJwtToken', async (accessToken, thunkApi) => {
    try {
        const response = await axios.post(
            `${process.env.REACT_APP_BACK_SERVER}/auth/google/callback`,
            {
...
export const checkLogin = createAsyncThunk('auth/checkLogin', async (_, thunkApi) => {
    try {
...
// 프로필 이미지 업로드 액션
export const uploadProfileImage = createAsyncThunk('members/uploadProfileImage', async (formData, thunkApi) => {
    try {
...
// 충전 요청 액션
export const chargeAccount = createAsyncThunk('account/chargeAccount', async (dummyData, thunkApi) => {
    try {
...
// 환전 요청 액션
export const exchangeAccount = createAsyncThunk('account/exchangeAccount', async (dummyData, thunkApi) => {
    try {
...
// 구매 요청 액션
export const buyAuction = createAsyncThunk('account/buyAuction', async (dummyData, thunkApi) => {
    try {
...
// 판매 요청 액션
export const sellAuction = createAsyncThunk('account/sellAuction', async (dummyData, thunkApi) => {
    try {
...
export const fetchMember = createAsyncThunk('member/fetchMember', async (_, thunkApi) => {
    try {
