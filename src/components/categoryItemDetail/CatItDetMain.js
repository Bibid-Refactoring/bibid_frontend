...
const CatItDetMain = ({
    ...
    const decreaseBid = (bidIncrement) => {
        setBidAmount((prevBid) =>
            Math.max(prevBid - bidIncrement, parseInt(infoExtension[1]) + parseInt(bidIncrement))
        );
    };
    ...
    const handleBidNow = () => {
        if (!checkLoginState) {
            ...
            axios
                .post(
                    `${process.env.REACT_APP_BACK_SERVER}/auctionDetail/category-item-detail/${auctionItem.auctionIndex}`,
                    biddingData,
                    {
                        headers: {
                        ...
                        <div className="CID-merchant-link">
                            ...
                            >
                                ...
                                <div className="CID-seller-modal-confirm-button-box">
                                    <button className="CID-seller-modal-confirm-button" onClick={closeSellerModal}>
                                        확인
                                    </button>
                                </div>
                            </Modal>
                ...
                <div className="CID-bid-section">
                    ...
                    <div className="CID-bid-container">
                        ...
                        <div className="CID-bid-cotents">
                            ...
                            <p>
                                {parseInt(infoExtension[0]).toLocaleString()}회
                                <span className="CID-hover-link" onClick={openBiddingRecordModal}>
                                    {' '}
                                    [기록보기]
                                </span>
                            </p>
                            ...
                            >
                                ...
                                <button className="CID-bidding-record-confirm-button" onClick={closeBiddingRecordModal}>
                                    확인
                                </button>
                            </Modal>
                            ...
                            <div className="CID-bid-input-wrapper">
                                ...
                                원{/* 백엔드 로직 : bidInfo테이블의 최신입찰가 */}
                                <div className="CID-bid-buttons-vertical">
                                    <button
                                        className="CID-bid-plus-button"
                                        sx={{ width: '10px' }}
                                    ...
                                    <button
                                        className="CID-bid-minus-button"
                            ...
                            <div className="CID-bid-expected-price">
                                ...
                                <p>
                                    (입찰 희망가 {nowBiddingInfo.bidPrice.toLocaleString()} 원 + 구매수수료{' '}
                                    {parseInt(nowBiddingInfo.purchaseFee).toLocaleString()} 원)
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="CID-bid-buttons">
                        ...
                        <button className="CID-bid-button" onClick={openBiddingNowModal}>
                            <p>입찰하기</p>
                        </button>
                        <Modal
                        ...
                        >
                            ...
                            <div className="CID-bidding-now-modal-body">
                                ...
                                <div className="CID-bidding-now-modal-details">
                                    ...
                                    <p>
                                        <strong className="bidding-now-modal-details-p">경매 분류 : </strong>{' '}
                                        {auctionItem.category}
                                    </p>
                                    <p>
                                        <strong className="bidding-now-modal-details-p">입찰 희망가 : </strong>{' '}
                                        <span className="CID-highlight-red">
                                            {nowBiddingInfo.bidPrice.toLocaleString()} 원
                                        </span>
                                    </p>
                                    <p>
                                        <strong className="bidding-now-modal-details-p">구매 예상가 : </strong>{' '}
                                        {parseInt(totalPrice).toLocaleString()} 원
                                    </p>
                                    <p className="bidding-now-modal-price-info">
                                        (입찰 희망가 {nowBiddingInfo.bidPrice.toLocaleString()} 원 + 구매수수료{' '}
                                        {parseInt(nowBiddingInfo.purchaseFee).toLocaleString()} 원)
                                    </p>
                                </div>
                        ...
                        >
                            ...
                            <div className="CID-bidding-now-modal-body">
                                ...
                                <div className="CID-bidding-now-modal-details">
                                    ...
                                    <p>
                                        <strong className="bidding-now-modal-details-p">즉시 구매가 : </strong>{' '}
                                        {nowBuyingInfo.buyNowPrice.toLocaleString()} 원
                                    </p>
                                    <p>
                                        <strong className="bidding-now-modal-details-p">총 결재금액 : </strong>
                                        <span className="CID-highlight-red"> {paymentAccount.toLocaleString()}</span> 원
                                    </p>
                                    <p className="biddng-now-modal-price-info">
                                        (즉시 구매가 {nowBuyingInfo.buyNowPrice.toLocaleString()} 원 + 구매 수수료{' '}
                                        {nowBuyingInfo.buyNowpurchaseFee.toLocaleString()} 원)
                                    </p>
                                </div>
                            </div>
                            <div className="CID-bidding-now-modal-bid-button-box">
                                <button className="CID-bidding-now-modal-bid-button" onClick={handleBuyNow}>
                                    즉시 구매
                                </button>
                            </div>
                        </Modal>
